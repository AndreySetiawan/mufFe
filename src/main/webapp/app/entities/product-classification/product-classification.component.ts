...
@Component({
    selector: 'jhi-product-classification',
    templateUrl: './product-classification.component.html'
})
export class ProductClassificationComponent extends AbstractEntityComponent<IProductClassification> {
    ...
    constructor(
        ...
        this.parentRoute = '/product-classification';
    ...
    downloadFile(name: string) {
        this.itemService
            .process(
                {
                    fileName: name,
                    header: 'idClassification',
                    fields: 'idClassification'
                },
