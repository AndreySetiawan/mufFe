...
@Component({
    selector: 'jhi-product-category-type',
    templateUrl: './product-category-type.component.html'
})
export class ProductCategoryTypeComponent extends AbstractEntityComponent<IProductCategoryType> {
    ...
    constructor(
        ...
        this.parentRoute = '/product-category-type';
    ...
    trackId(index: number, item: IProductCategoryType) {
        return item.idCategoryType;
    }

    get productCategoryTypes() {
        return this.items;
    }

    set productCategoryTypes(productCategoryType: IProductCategoryType[]) {
        this.items = productCategoryType;
    }
