...
import { PartyCategoryTypeComponent, PartyCategoryTypeDetailComponent, PartyCategoryTypeUpdateComponent, partyCategoryTypeRoute } from './';

const ENTITY_STATES = [...partyCategoryTypeRoute];
...
export class MufFePartyCategoryTypeModule {
