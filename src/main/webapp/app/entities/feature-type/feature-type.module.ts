...
import { FeatureTypeComponent, FeatureTypeDetailComponent, FeatureTypeUpdateComponent, featureTypeRoute } from './';

const ENTITY_STATES = [...featureTypeRoute];
...
export class MufFeFeatureTypeModule {
