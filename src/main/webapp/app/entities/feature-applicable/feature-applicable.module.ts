...
import { FeatureApplicableComponent, FeatureApplicableDetailComponent, FeatureApplicableUpdateComponent, featureApplicableRoute } from './';

const ENTITY_STATES = [...featureApplicableRoute];
...
export class MufFeFeatureApplicableModule {
