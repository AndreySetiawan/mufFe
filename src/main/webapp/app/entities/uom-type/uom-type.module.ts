...
import { UomTypeComponent, UomTypeDetailComponent, UomTypeUpdateComponent, uomTypeRoute } from './';

const ENTITY_STATES = [...uomTypeRoute];
...
export class MufFeUomTypeModule {
