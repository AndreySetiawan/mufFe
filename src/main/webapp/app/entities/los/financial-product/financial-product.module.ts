...
import { FinancialProductComponent, FinancialProductDetailComponent, FinancialProductUpdateComponent, financialProductRoute } from './';

const ENTITY_STATES = [...financialProductRoute];
...
export class MufFeFinancialProductModule {
